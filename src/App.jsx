...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] text-stone-800 font-sans antialiased selection:bg-stone-200">
      ...
      {/* NAVBAR */}
      <nav className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center bg-white/70 backdrop-blur-md sticky top-0 z-50 border-b border-stone-200/50">
        {/* LOGO */}
        <div className="flex items-center">
          <img
            src="/aurealogo.jpeg"
            alt="Áurea Centro Terapéutico"
      ...
      <section id="inicio" className="max-w-7xl mx-auto px-6 py-16 md:py-24 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="flex justify-center lg:justify-end order-1 lg:order-2">
          <div className="hero-anim relative w-full max-w-md" style={{ animationDelay: '0.1s' }}>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <Reveal delay={80} className="bg-emerald-50/50 p-10 rounded-3xl border border-emerald-100 space-y-6">
              <h3 className="font-serif text-2xl text-emerald-950">Este espacio es para ti si buscas:</h3>
              <ul className="space-y-5 text-stone-700 font-light">
                ...
                <li className="flex items-start">
                  <span className="text-emerald-700 mr-3 mt-1 text-lg">✦</span>
                  <span className="leading-relaxed">Acompañamiento seguro durante <strong>crisis emocionales, duelos</strong> o para superar consumos problemáticos.</span>
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-700 mr-3 mt-1 text-lg">✦</span>
            ...
            <Reveal delay={160} className="bg-[#FAFAF8] p-10 rounded-3xl border border-stone-200 space-y-6">
              <h3 className="font-serif text-2xl text-stone-500">Este espacio NO es para ti si...</h3>
              <ul className="space-y-5 text-stone-600 font-light">
                <li className="flex items-start">
                  <span className="text-stone-300 mr-3 mt-1 text-lg">✕</span>
                  <span className="leading-relaxed">Buscas soluciones superficiales de corto plazo sin disposición a explorar tu historia.</span>
                </li>
                <li className="flex items-start">
                  <span className="text-stone-300 mr-3 mt-1 text-lg">✕</span>
                  <span className="leading-relaxed">Quieres un régimen alimenticio estricto o enfoques basados en el castigo hacia tu cuerpo.</span>
                </li>
                <li className="flex items-start">
                  <span className="text-stone-300 mr-3 mt-1 text-lg">✕</span>
                  <span className="leading-relaxed">No tienes disponibilidad para comprometerte con sesiones regulares.</span>
                </li>
              </ul>
            </Reveal>
          </div>
      ...
      <section id="reconocimientos" className="py-24 border-y border-stone-200/60 bg-stone-50 overflow-hidden">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <Reveal delay={80} as="div" className="bg-white rounded-[2rem] border border-stone-200 shadow-sm p-8 md:p-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {[
                ...
                >
                  <img src={cert.src} alt={cert.label} className="w-full h-full object-cover group-hover:scale-105 transition duration-500 ease-out" />
          ...
          <Reveal delay={140} as="div" className="bg-white rounded-[2rem] border border-stone-200 shadow-sm p-8 md:p-10 mt-8">
            ...
            >
              <img src="/psiconutricion-diplomatura.png" alt="Diplomatura en Psiconutrición" className="w-full h-full object-cover group-hover:scale-105 transition duration-500 ease-out" />
              <div className="absolute inset-0 bg-stone-900/0 group-hover:bg-stone-900/30 transition duration-300 flex items-center justify-center">
                <span className="opacity-0 group-hover:opacity-100 transition text-white text-[10px] uppercase tracking-widest font-semibold">Ver completo</span>
              </div>
            </button>
        ...
        {certActivo && (
          ...
          >
            ...
            />
            <button onClick={() => setCertActivo(null)} className="absolute top-6 right-6 text-stone-300 hover:text-white text-3xl font-light">×</button>
          </div>
        )}
      </section>
      ...
      {modalEnfoques && (
        ...
        >
          <div
            className="bg-[#FAFAF8] rounded-[2rem] max-w-2xl w-full max-h-[85vh] overflow-y-auto p-8 md:p-12 shadow-2xl relative"
            onClick={(e) => e.stopPropagation()}
          >
            <button onClick={() => setModalEnfoques(false)} className="absolute top-6 right-6 text-stone-400 hover:text-stone-900 text-2xl font-light transition">×</button>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-sm text-stone-600 font-light leading-relaxed">Trabajo profundo en la relación con el cuerpo y la comida, sin dietas restrictivas ni enfoques punitivos.</p>
              </div>
            </div>
            <button
      ...
      <section id="filtro" className="bg-stone-900 py-24 text-stone-100">
        <div className="max-w-2xl mx-auto px-6">
          ...
          <Reveal delay={100} as="div" className="bg-white text-stone-900 p-8 md:p-12 rounded-[2rem] shadow-2xl relative overflow-hidden">
            ...
            {filtroPaso === 1 && (
              <div className="space-y-8 pt-4">
                ...
                <div className="grid gap-4">
                  <button onClick={() => { setMotivo('Completo'); setFiltroPaso(2); }} className="w-full text-left p-6 rounded-2xl border border-stone-200 hover:border-emerald-600 hover:bg-emerald-50 transition">
            ...
            {filtroPaso === 2 && (
              <div className="space-y-8 pt-4">
                <h4 className="font-serif text-xl md:text-2xl text-stone-900 text-center">2. El éxito requiere constancia. ¿Estás lista/o para comprometerte?</h4>
                <div className="grid gap-4">
            ...
            {filtroPaso === 3 && compromiso && (
              <div className="space-y-8 pt-4">
                <h4 className="font-serif text-xl md:text-2xl text-stone-900 text-center">3. Brevemente, ¿qué situación estás atravesando?</h4>
                <p className="text-center text-xs text-stone-500 font-light -mt-4">Esto ayuda a la Psicóloga a entender tu contexto antes de la primera sesión.</p>
                <div className="space-y-4">
                  <textarea
                    rows="4"
                    placeholder="Ej: Últimamente he tenido picos de ansiedad por el trabajo, me cuesta dormir..."
                    value={descripcion}
                ...
                {compromiso && motivo === 'Completo' ? (
                  ...
                  <>
                    ...
                    <p className="text-sm text-stone-600 max-w-md mx-auto leading-relaxed mt-4">
                      El enfoque clínico de Áurea está estructurado para procesos continuos. Te sugerimos comenzar explorando nuestros materiales gratuitos mientras encuentras el momento ideal.
                    </p>
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
                      <a href="#recursos" onClick={reiniciarFiltro} className="px-6 py-3 rounded-full border border-stone-300 text-stone-700 text-xs uppercase tracking-widest font-semibold hover:bg-stone-100 transition w-full sm:w-auto shadow-sm">
                        Ver Recursos
                      </a>
                      <button onClick={reiniciarFiltro} className="text-xs uppercase tracking-widest font-medium text-stone-400 hover:text-stone-800 transition w-full sm:w-auto">
                        Volver al inicio
                      </button>
                    </div>
                  </>
      ...
      <section id="contacto" className="max-w-7xl mx-auto px-6 py-24 border-t border-stone-200/60">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <Reveal as="div" className="space-y-10">
            <div className="space-y-4">
              <span className="text-xs uppercase tracking-[0.2em] text-emerald-700 font-semibold block">No tienes que hacerlo en soledad</span>
              ...
              <p className="text-sm text-stone-600 font-light max-w-md leading-relaxed pt-2">
                Ya sea que estés lista/o para agendar tu espacio clínico o prefieras ir a tu propio ritmo, aquí tienes las puertas abiertas.
              </p>
            </div>
      ...
      <footer className="bg-stone-950 text-stone-400 py-16 text-sm border-t border-stone-900 rounded-t-[3rem] mt-12 mx-2 md:mx-6">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid md:grid-cols-3 gap-12 items-start">
          <div className="space-y-4">
            <img src="/aurealogo.jpeg" alt="Áurea" className="h-10 w-auto object-contain brightness-0 invert opacity-80" />
